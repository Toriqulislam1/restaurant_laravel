...
<html lang="en">
  ...
  <body>
    <div class="container-scroller">
      ...
      @include('admin.partial')
        <!-- partial -->
        <form action="{{url('productAddDb')}}" method="POST" enctype="multipart/form-data">
            @csrf
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="descriptionc" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
